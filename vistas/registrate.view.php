...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/estiRegis.css">
    ...
    <body>
        <div class="contenedor">
            ...
            <section class="main">
                ...
                <form class="formulario" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="login">
                    <div class="form-group"> 
                        <i class="icono fa fa-user" aria-hidden="true"></i> 
                        <input type="text" name="usuario" placeholder="Crea nombre de usuario" class="caja">
                    </div>
                    <div class="form-group"> 
                    ...
                    <div class="form-group"> 
                        <i class="icono fa fa-key" aria-hidden="true"></i><input type="password" name="Rpassword" placeholder="Repetir contraseña" class="caja">
                    </div>
                    <div class="form-group">
                        <i class="submit-btn fa fa-chevron-circle-right" aria-hidden="true" onclick="login.submit()"></i>
                    </div>

                    <!--Para imprimir si en caso hay algún error
            ...
            <aside class="iniciar">
                ...
                <div class="abrir">
                    <a href="Iniciar.php">Inicia Sesión</a>
                </div>
            </aside>
